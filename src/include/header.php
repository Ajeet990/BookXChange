...
$userManager = $permission->get_access_user();
$bookManager = $permission->get_access_book();
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href=""><img src="<?php $base_url ?>/bookxchange/src/img/<?php echo $logo; ?>"
                    width="50px" alt="Logo Image"></a>

            <?php } if(isset($_SESSION['login'])) { ?>

            <a class="navbar-brand" href="<?php $base_url ?>/bookxchange/src/view/welcome.php"><img
                    src="<?php $base_url ?>/bookxchange/src/img/<?php echo $logo; ?>" width="50px" alt="Logo Image"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                       ...
                       <?php if($_SESSION['loggedIn'] == 'userManager'){ 
                                if($userManager['user_table'] == 1 ) {
                                 ?>
                                <a class="nav-link active" href="<?php $base_url ?>/bookxchange/src/view/user_list.php">Users</a>
                        <!-- for book Manager -->
                        <?php }} if($_SESSION['loggedIn'] == 'userManager'){ 
                    ...
                    <?php if($_SESSION['loggedIn'] == 'userManager'){ 
                                if($userManager['book_table'] == 1 ) {
                                 ?>
                        <a class="nav-link active" href="<?php $base_url ?>/bookxchange/src/view/book_list.php">Books</a>
                        <?php }} ?>
                    ...
                    <?php if($_SESSION['loggedIn'] == 'userManager'){ 
                                if($userManager['request'] == 1 ) {
                                 ?>
                        <a class="nav-link active" href="<?php $base_url ?>/bookxchange/src/view/request.php">Request</a>
                        <?php }} ?>
                    <?php if($_SESSION['loggedIn'] == 'bookManager'){ 
                    ...
                    <?php if($_SESSION['loggedIn'] == 'userManager'){ 
                                if($userManager['settings'] == 1 ) {
                                 ?>
                        <a href="<?php $base_url ?>/bookxchange/src/settings/setting.php"
                    ...
                    <?php if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']== 'superadmin') { ?>
                    <li class="nav-item">
                        <a href="<?php $base_url ?>/bookxchange/src/settings/permission.php"
            ...
            <?php if(isset($_SESSION['loggedIn'])){
                echo '<p class="text-light mx-3">Welcome : '.$_SESSION['loggedIn'].'</p>';
            } ?>


            <a href="<?php $base_url ?>/bookxchange/src/view/logout.php" class="btn btn-primary">LogOut</a>
